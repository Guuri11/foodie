        ...
        'error',
        {
          ...
          rules: [
            ...
            // CORE: Dependency injection and global utilities
            {
              ...
              allow: ['domain', 'application', 'infrastructure', 'presentation-core'],
              message:
  ...
  // Feature screens (similar to containers in web)
  {
    ...
    rules: {
      ...
      'no-restricted-syntax': [
        'error',
        {
          selector: 'NewExpression[callee.name=/Repository/], NewExpression[callee.name=/UseCase/]',
          message:
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['**/features/**'],
              message: 'Core hooks should be generic and not depend on specific features.',
            },
            {
              group: ['**/infrastructure/**'],
